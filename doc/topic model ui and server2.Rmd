...
ui=fluidPage(includeCSS("C:/Users/Alienware/Desktop/ads project1/Spring2019-Proj2-grp10//app/style.css"),navbarPage(p(class="h","JobsSmart"),id = "inTabset",
  ...
  output$mymap2 <- renderLeaflet({
   m <- leaflet(data=data) %>%
          ...
          addMarkers(lng = ~bar$Longitude,
                     lat = ~bar$Latitude
                     ,
                     icon = list(iconUrl='C:/Users/Alienware/Desktop/ads project1/Spring2019-Proj2-grp10/lib/bar.png',iconSize=c(15,15)))%>%
     addMarkers(lng = ~bus$LONGITUDE,
                     lat = ~bus$LATITUDE
                     ,
                     icon = list(iconUrl='C:/Users/Alienware/Desktop/ads project1/Spring2019-Proj2-grp10/lib/bus.png',iconSize=c(15,15)))%>%
      addMarkers(lng = ~Cinmea$lon,
                     lat = ~Cinmea$lat
                     ,
                     icon = list(iconUrl='C:/Users/Alienware/Desktop/ads project1/Spring2019-Proj2-grp10/lib/Movie.png',iconSize=c(15,15)))%>%
      addMarkers(lng = ~subway$Station.Longitude,
                     lat = ~subway$Station.Latitude
                     ,
                     icon = list(iconUrl='C:/Users/Alienware/Desktop/ads project1/Spring2019-Proj2-grp10/lib/metro.png',iconSize=c(15,15)))
